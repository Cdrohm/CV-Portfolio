...
// project list
    {
        ...
        source: 'https://github.com/Cdrohm/booki',
        info: 'Site vitrine d une agence de location saisonnière, spécialisée sur la ville de Marseille.',
...

    {
        ...
        languages: ['html', 'css', 'javascript', 'React JS'],
        languagesIcons: ['fab fa-html5', 'fab fa-css3-alt', 'fab fa-js', 'fab fa-react'],
        source: 'https://github.com/Cdrohm/Kasa',
        info: 'Application de location de logements entre particuliers. Site en ASP.NET à refondre en React JS. Création des composants, animations des menus. ',
    ...
    
    {
        ...
        source: 'https://github.com/Cdrohm/learn-home',
        info: 'Création d une maquette pour une application de soutien scolaire. Visuel sous FIGMA, use case, user stories, recherche des besoins, Kanban. ',
        picture: './media/learnathome.jpg'
    },
...

    {
        ...
        languagesIcons: ['fab fa-html5', 'fab fa-css3-alt', 'fab fa-js', 'fab fa-react'],
        source: 'https://github.com/Cdrohm/Argent-Bank',
        info: 'Application bancaire avec connection protègée par token, permettant la visualisation de son porte monnaie et des transactions. Gestion du back-end par MongoDB, actualisation des modifications de transactions, possibilité d ajouter des notes. Création d un fichier swagger.',
        picture: './media/argentbank.jpg'
    },
